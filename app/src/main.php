        ...
        <div class="banner">
            <div class="row justify-content-center">
                <div class="col-12 col-xl-10">
                    <div class="lh-1 fs-30 font-kamerik fw-300">Looking to finance a <span class="fw-700">Trailer?</span></div>
            ...
            <div class="col-xl-6">
                <div class="row justify-content-center align-items-center h-100">
                    <div class="col-lg-10 text-center py-5 py-md-7 px-4">
                        <div class="text-white fs-64 lh-1 fw-500">Speak with a Trailer Finance Expert Today!</div>
                        <div class="text-white font-kamerik fs-20 py-5">Compare and save on your next trailer loan by speaking with our trailer finance experts. Our 30-second online application process only requires you to provide the details we truly need.</div>
